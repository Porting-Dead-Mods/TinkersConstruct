...
public class PageIconLinkElement extends SizedBookElement {
  ...
  public void draw(GuiGraphics matrices, int mouseX, int mouseY, float partialTicks, Font fontRenderer) {
    ...
    if (this.isHovered(mouseX, mouseY)) {
      matrices.fill(this.x, this.y, this.x + this.width, this.y + this.height, this.parent.book.appearance.hoverColor | (0x77 << 24));
    }
  ...
  @Override
  public void drawOverlay(GuiGraphics matrices, int mouseX, int mouseY, float partialTicks, Font fontRenderer) {
